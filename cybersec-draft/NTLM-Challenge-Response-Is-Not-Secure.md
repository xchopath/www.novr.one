...
Metode **NTLM Challenge/Response** ini memiliki beberapa kekurangan, seperti rentan terhadap serangan "Replay Attack" di mana penyerang dapat mencuri respons yang valid yang di mana berisi HASH dari Password milik Client. Oleh karena itu, metode autentikasi yang lebih aman seperti `Kerberos` telah diperkenalkan sebagai alternatif untuk `NTLM`.
